              ...
              >
                <td class="flex gap-x-4 items-center py-4 pl-10">
                  ...
                  <div>
                    ...
                    <div class="font-medium text-gray-400">{ products.category }</div>
                  </div>
                </td>
                <td class="font-medium text-center">${ products.price }</td>
                <td class="font-medium text-center">{ products.downloaded }</td>
                <td class="text-center">
                  <span class="font-medium">{ products.rating }</span>
